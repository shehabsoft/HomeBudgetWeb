...
0,d=0>d?Math.ceil(d):Math.floor(d);for(0>d&&(d+=b);d<b;d++)if(d in this&&this[d]===a)return d;return-1}function x(a){return null===a||"undefined"===typeof a}function ra(a){a.indexOf||(a.indexOf=Sa);return a}function Ka(a,c,b){b=b||"normal";var d=a+"_"+c+"_"+b,f=La[d];if(isNaN(f)){try{a="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+a+"; font-size:"+c+"px; font-weight:"+b+";";if(!ca){var g=document.body;ca=document.createElement("span");
ca.innerHTML="";var k=document.createTextNode("Mpgyi");ca.appendChild(k);g.appendChild(ca)}ca.style.display="";ca.setAttribute("style",a);f=Math.round(ca.offsetHeight);ca.style.display="none"}catch(h){f=Math.ceil(1.1*c)}f=Math.max(f,c);La[d]=f}return f}function F(a,c){var b=[];if(b={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,2],dashDot:[4,2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[a||"solid"])for(var d=
0;d<b.length;d++)b[d]*=c;else b=[];return b}function K(a,c,b,d){if(a.addEventListener)a.addEventListener(c,b,d||!1);else if(a.attachEvent)a.attachEvent("on"+c,function(d){d=d||window.event;d.preventDefault=d.preventDefault||function(){d.returnValue=!1};d.stopPropagation=d.stopPropagation||function(){d.cancelBubble=!0};b.call(a,d)});else return!1}function Ma(a,c,b){a*=L;c*=L;a=b.getImageData(a,c,2,2).data;c=!0;for(b=0;4>b;b++)if(a[b]!==a[b+4]|a[b]!==a[b+8]|a[b]!==a[b+12]){c=!1;break}return c?a[0]<<
16|a[1]<<8|a[2]:0}function N(a,c,b){return a in c?c[a]:b[a]}function sa(a,c,b){if(v&&Na){var d=a.getContext("2d");ta=d.webkitBackingStorePixelRatio||d.mozBackingStorePixelRatio||d.msBackingStorePixelRatio||d.oBackingStorePixelRatio||d.backingStorePixelRatio||1;L=Ba/ta;a.width=c*L;a.height=b*L;Ba!==ta&&(a.style.width=c+"px",a.style.height=b+"px",d.scale(L,L))}else a.width=c,a.height=b}function Ta(a){if(!Ua){var c=!1,b=!1;"undefined"===typeof ga.Chart.creditHref?(a.creditHref="http://canvasjs.com/",
...
b&&(c.setAttribute("state",b),c.setAttribute("type","button"),c.style.position="relative",c.style.margin="0px 0px 0px 0px",c.style.padding="3px 4px 0px 4px",c.style.cssFloat="left",c.setAttribute("title",a._cultureInfo[b+"Text"]),c.innerHTML="<img style='height:16px;' src='"+Va[b].image+"' alt='"+a._cultureInfo[b+"Text"]+"' />")}function ua(){for(var a=null,c=0;c<arguments.length;c++)a=arguments[c],a.style&&(a.style.display="inline")}function $(){for(var a=null,c=0;c<arguments.length;c++)(a=arguments[c])&&
a.style&&(a.style.display="none")}function J(a,c,b,d){this._defaultsKey=a;this.parent=d;this._eventListeners=[];d={};b&&(ja[b]&&ja[b][a])&&(d=ja[b][a]);this.options=c?c:{_isPlaceholder:!0};this.setOptions(this.options,d)}function z(a,c){c=c||{};z.base.constructor.call(this,"Chart",c,c.theme?c.theme:"theme1");var b=this;this._containerId=a;this._objectsInitialized=!1;this.overlaidCanvasCtx=this.ctx=null;this._indexLabels=[];this._panTimerId=0;this._lastTouchEventType="";this._lastTouchData=null;this.isAnimating=
...
"auto";v||(this._canvasJSContainer.style.height="0px");this.container.appendChild(this._canvasJSContainer);this.canvas=ha(d,f);this.canvas.style.position="absolute";this.canvas.getContext&&(this._canvasJSContainer.appendChild(this.canvas),this.ctx=this.canvas.getContext("2d"),this.ctx.textBaseline="top",Ra(this.ctx),v?this.plotArea.ctx=this.ctx:(this.plotArea.canvas=ha(d,f),this.plotArea.canvas.style.position="absolute",this.plotArea.canvas.setAttribute("class","plotAreaCanvas"),this._canvasJSContainer.appendChild(this.plotArea.canvas),
this.plotArea.ctx=this.plotArea.canvas.getContext("2d")),this.overlaidCanvas=ha(d,f),this.overlaidCanvas.style.position="absolute",this._canvasJSContainer.appendChild(this.overlaidCanvas),this.overlaidCanvasCtx=this.overlaidCanvas.getContext("2d"),this.overlaidCanvasCtx.textBaseline="top",this._eventManager=new ma(this),K(window,"resize",function(){b._updateSize()&&b.render()}),this._toolBar=document.createElement("div"),this._toolBar.setAttribute("class","canvasjs-chart-toolbar"),this._toolBar.style.cssText=
...
(0<=a.toString().indexOf("%")?c/100:1);return!isNaN(b)&&b<=c&&0<=b?b:c}function ka(a,c,b,d,f){"undefined"===typeof f&&(f=0);this._padding=f;this._x1=a;this._y1=c;this._x2=b;this._y2=d;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function W(a,c){W.base.constructor.call(this,"TextBlock",c);this.ctx=a;this._isDirty=!0;this._wrappedText=null}function na(a,c){na.base.constructor.call(this,"Title",c,a.theme,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;
...
this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function wa(a,c){wa.base.constructor.call(this,"Subtitle",c,a.theme,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.optionsName="subtitles";this.isOptionsInArray=!0;"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function xa(a,c){xa.base.constructor.call(this,"Legend",c,a.theme,a);this.chart=
...
ha(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function pa(a){var c;a&&qa[a]&&(c=qa[a]);pa.base.constructor.call(this,"CultureInfo",c)}function Ea(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;this.animations=[];this.animationRequestId=null}var ya={},v=!!document.createElement("canvas").getContext,ga={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"theme1",animationEnabled:!1,animationDuration:1200,
...
k=/[^-+\dA-Z]/g;return function(h,l,n){var m=n?n.days:c,p=n?n.months:d,e=n?n.shortDays:b,r=n?n.shortMonths:f;n="";var q=!1;h=h&&h.getTime?h:h?new Date(h):new Date;if(isNaN(h))throw SyntaxError("invalid date");"UTC:"===l.slice(0,4)&&(l=l.slice(4),q=!0);n=q?"getUTC":"get";var s=h[n+"Date"](),u=h[n+"Day"](),w=h[n+"Month"](),y=h[n+"FullYear"](),t=h[n+"Hours"](),v=h[n+"Minutes"](),aa=h[n+"Seconds"](),X=h[n+"Milliseconds"](),x=q?0:h.getTimezoneOffset();return n=l.replace(a,function(a){switch(a){case "D":return s;
...
2);case "f":return String(X).slice(0,1);case "ff":return P(String(X).slice(0,2),2);case "fff":return P(String(X).slice(0,3),3);case "t":return 12>t?"a":"p";case "tt":return 12>t?"am":"pm";case "T":return 12>t?"A":"P";case "TT":return 12>t?"AM":"PM";case "K":return q?"UTC":(String(h).match(g)||[""]).pop().replace(k,"");case "z":return(0<x?"-":"+")+Math.floor(Math.abs(x)/60);case "zz":return(0<x?"-":"+")+P(Math.floor(Math.abs(x)/60),2);case "zzz":return(0<x?"-":"+")+P(Math.floor(Math.abs(x)/60),2)+
P(Math.abs(x)%60,2);default:return a.slice(1,a.length-1)}})}}(),da=function(a,c,b){if(null===a)return"";a=Number(a);var d=0>a?!0:!1;d&&(a*=-1);var f=b?b.decimalSeparator:".",g=b?b.digitGroupSeparator:",",k="";c=String(c);var k=1,h=b="",l=-1,n=[],m=[],p=0,e=0,r=0,q=!1,s=0,h=c.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);c=null;for(var u=0;h&&u<h.length;u++)if(c=h[u],"."===c&&0>l)l=u;else{if("%"===c)k*=100;else if("\u2030"===c){k*=1E3;continue}else if(","===c[0]&&"."===c[c.length-1]){k/=
...
menu:{image:"data:image/png;base64,"}};J.prototype.setOptions=function(a,c){if(ga[this._defaultsKey]){var b=ga[this._defaultsKey],d;for(d in b)"publicProperties"!==d&&b.hasOwnProperty(d)&&(this[d]=
a&&d in a?a[d]:c&&d in c?c[d]:b[d])}};J.prototype.get=function(a){var c=ga[this._defaultsKey];if("options"===a)return this.options&&this.options._isPlaceholder?null:this.options;if(c.hasOwnProperty(a)||c.publicProperties&&c.publicProperties.hasOwnProperty(a))return this[a];window.console&&window.console.log('Property "'+a+"\" doesn't exist. Please check for typo.")};J.prototype.set=function(a,c,b){b="undefined"===typeof b?!0:b;var d=ga[this._defaultsKey];if("options"===a)this.createUserOptions(c);
...
a._dropDownCloseTime=new Date},!0);var c=document.createElement("div");c.style.cssText="padding: 2px 15px 2px 10px";c.innerHTML=this._cultureInfo.printText;this._dropdownMenu.appendChild(c);K(c,"mouseover",function(){this.style.backgroundColor="#EEEEEE"},!0);K(c,"mouseout",function(){this.style.backgroundColor="transparent"},!0);K(c,"click",function(){a.print();$(a._dropdownMenu)},!0);c=document.createElement("div");c.style.cssText="padding: 2px 15px 2px 10px";c.innerHTML=this._cultureInfo.saveJPGText;
...
"transparent"},!0);K(c,"click",function(){Ca(a.canvas,"png",a.exportFileName);$(a._dropdownMenu)},!0)}"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?T(a,a._zoomButton,"zoom"):T(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&T(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(var b in this.toolTip.options)this.toolTip.options.hasOwnProperty(b)&&
this.toolTip.updateOption(b)};z.prototype._updateSize=function(){var a=0,c=0;this.options.width?a=this.width:this.width=a=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?c=this.height:this.height=c=0<this.container.clientHeight?this.container.clientHeight:this.height;return this.canvas.width!==a*L||this.canvas.height!==c*L?(sa(this.canvas,a,c),sa(this.overlaidCanvas,a,c),sa(this._eventManager.ghostCanvas,a,c),!0):!1};z.prototype._initialize=function(){this._animator?
...
[];this._events=[];this._eventManager&&this._eventManager.reset();this.plotInfo={axisPlacement:null,axisXValueType:null,plotTypes:[]};this.layoutManager=new ka(0,0,this.width,this.height,2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];var a=0;if(this.options.data)for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=z._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new ba(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);
...
new na(this,this.options.title),this.title.dockInsidePlotArea?c.push(this.title):this.title.render());if(this.options.subtitles)for(this.subtitles=[],a=0;a<this.options.subtitles.length;a++)b=new wa(this,this.options.subtitles[a]),this.subtitles.push(b),b.dockInsidePlotArea?c.push(b):b.render();this.legend=new xa(this,this.options.legend);for(a=0;a<this.data.length;a++)(this.data[a].showInLegend||"pie"===this.data[a].type||"doughnut"===this.data[a].type)&&this.legend.dataSeries.push(this.data[a]);
this.legend.dockInsidePlotArea?c.push(this.legend):this.legend.render();if("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)A.setLayoutAndRender(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement,this.layoutManager.getFreeSpace());else if("none"===this.plotInfo.axisPlacement)this.preparePlotArea();else return;for(a=0;a<c.length;a++)c[a].render();var d=[];if(this.animatedRender){var f=ha(this.width,this.height);f.getContext("2d").drawImage(this.canvas,
0,0,this.width,this.height)}for(a=0;a<this.plotInfo.plotTypes.length;a++)for(var c=this.plotInfo.plotTypes[a],g=0;g<c.plotUnits.length;g++){var k=c.plotUnits[g],h=null;k.targetCanvas=null;this.animatedRender&&(k.targetCanvas=ha(this.width,this.height),k.targetCanvasCtx=k.targetCanvas.getContext("2d"));"line"===k.type?h=this.renderLine(k):"stepLine"===k.type?h=this.renderStepLine(k):"spline"===k.type?h=this.renderSpline(k):"column"===k.type?h=this.renderColumn(k):"bar"===k.type?h=this.renderBar(k):
...
this.animatedRender&&h&&d.push(h)}this.animatedRender&&0<this._indexLabels.length&&(a=ha(this.width,this.height).getContext("2d"),d.push(this.renderIndexLabels(a)));var l=this;0<d.length?(l.disableToolTip=!0,l._animator.animate(200,l.animationDuration,function(a){l.ctx.clearRect(0,0,l.width,l.height);l.ctx.drawImage(f,0,0,Math.floor(l.width*L),Math.floor(l.height*L),0,0,l.width,l.height);for(var b=0;b<d.length;b++)h=d[b],1>a&&"undefined"!==typeof h.startTimePercent?a>=h.startTimePercent&&h.animationCallback(h.easingFunction(a-
...
c,b){b=b||!1;for(var d=[],f=this._dataInRenderedOrder.length-1;0<=f;f--){var g=null;(g=this._dataInRenderedOrder[f].getDataPointAtXY(a,c,b))&&d.push(g)}a=null;c=!1;for(b=0;b<d.length;b++)if("line"===d[b].dataSeries.type||"stepLine"===d[b].dataSeries.type||"area"===d[b].dataSeries.type||"stepArea"===d[b].dataSeries.type)if(f=N("markerSize",d[b].dataPoint,d[b].dataSeries)||8,d[b].distance<=f/2){c=!0;break}for(b=0;b<d.length;b++)c&&"line"!==d[b].dataSeries.type&&"stepLine"!==d[b].dataSeries.type&&"area"!==
...
"zoom"),k&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(ua(this._zoomButton,this._resetButton),T(this,this._zoomButton,"pan"),T(this,this._resetButton,"reset")))}}this.isDrag=!1};z.prototype._plotAreaMouseMove=function(a,c){if(this.isDrag&&"none"!==this.plotInfo.axisPlacement){var b=0,d=0,f=b=null,f=0<=this.zoomType.indexOf("x"),g=0<=this.zoomType.indexOf("y"),k=this;"xySwapped"===this.plotInfo.axisPlacement&&(b=g,g=f,f=b);b=this.dragStartPoint.x-a;d=this.dragStartPoint.y-c;2<Math.abs(b)&&
...
a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new ka(a.x1,a.y1,a.x2,a.y2,2)};z.prototype.renderIndexLabels=function(a){a=a||this.plotArea.ctx;for(var c=this.plotArea,b=0,d=0,f=0,g=0,k=b=g=d=f=0,h=0,l=0;l<this._indexLabels.length;l++){var n=this._indexLabels[l],m=n.chartType.toLowerCase(),p,e,r=N("indexLabelFontColor",n.dataPoint,n.dataSeries),k=N("indexLabelFontSize",n.dataPoint,n.dataSeries),h=N("indexLabelFontFamily",n.dataPoint,n.dataSeries);p=N("indexLabelFontStyle",
n.dataPoint,n.dataSeries);e=N("indexLabelFontWeight",n.dataPoint,n.dataSeries);var g=N("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),d=N("indexLabelMaxWidth",n.dataPoint,n.dataSeries),f=N("indexLabelWrap",n.dataPoint,n.dataSeries),q=N("indexLabelLineDashType",n.dataPoint,n.dataSeries),s=N("indexLabelLineColor",n.dataPoint,n.dataSeries),u=x(n.dataPoint.indexLabelLineThickness)?x(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,
...
n.dataPoint.indexLabelFormatter(y):n.dataPoint.indexLabel?this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?n.dataSeries.indexLabelFormatter(y):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==t&&""!==t){var w=N("indexLabelPlacement",n.dataPoint,n.dataSeries),y=N("indexLabelOrientation",n.dataPoint,n.dataSeries),v=n.direction,aa=
...
n.dataPoint.y<X.viewportMinimum||n.dataPoint.y>X.viewportMaximum)continue}else if(0<=m.indexOf("column")){if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum||n.bounds.y1>c.y2||n.bounds.y2<c.y1)continue}else if(0<=m.indexOf("bar")){if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum||n.bounds.x1>c.x2||n.bounds.x2<c.x1)continue}else if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum)continue;d=g=2;"horizontal"===y?(k=r.width,h=r.height):(h=r.width,
...
dataSeriesIndex:n,dataPointIndex:r,x1:q,y1:s};0!==p[r].markerSize&&(0<p[r].markerSize||0<m.markerSize)&&(u=m.getMarkerProperties(r,q,s,b),h=u.color,k.push(u),H=D(H),v&&k.push({x:q,y:s,ctx:d,type:u.type,size:u.size,color:H,borderColor:H,borderThickness:u.borderThickness}));(p[r].indexLabel||m.indexLabel||p[r].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:p[r],dataSeries:m,point:{x:q,y:s},direction:0>p[r].y===a.axisY.reversed?1:-1,color:G})}c();O.drawMarkers(k);
m.markerColor=h}}b.restore();v&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,animationBase:0}}};z.prototype.renderSplineArea=function(a){function c(){var c=va(y,2);if(0<c.length){if(0<m.lineThickness){b.beginPath();b.moveTo(c[0].x,c[0].y);c[0].newStrokeStyle&&(b.strokeStyle=c[0].newStrokeStyle);c[0].newLineDashArray&&b.setLineDash(c[0].newLineDashArray);for(var e=0;e<c.length-3;e+=3)if(b.bezierCurveTo(c[e+
...
m.indexLabel||p[e].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[e],dataSeries:m,point:{x:r,y:q},direction:0>p[e].y===a.axisY.reversed?1:-1,color:t});q=!1}c();O.drawMarkers(k);m.markerColor=h}}b.restore();v&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,animationBase:0}}};z.prototype.renderStepArea=function(a){function c(){t&&(0<m.lineThickness&&
...
y,t=null,G=!1;if(0<p.length){var x=m._colorSet[r%m._colorSet.length],z=m.lineColor=m.options.lineColor||x,A=z;b.fillStyle=x;b.strokeStyle=z;b.lineWidth=m.lineThickness;var R="solid";if(b.setLineDash){var Q=F(m.nullDataLineDashType,m.lineThickness),R=m.lineDashType,I=F(R,m.lineThickness);b.setLineDash(I)}for(;r<p.length;r++)if(u=p[r].x.getTime?p[r].x.getTime():p[r].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!G))){var H=s;"number"!==typeof p[r].y?(m.connectNullData||
(G||e)||c(),G=!0):(q=a.axisX.convertValueToPixel(u),s=a.axisY.convertValueToPixel(p[r].y),e||G?(!e&&m.connectNullData?(b.setLineDash&&(m.options.nullDataLineDashType||R===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(b.stroke(),R=m.nullDataLineDashType,b.setLineDash(Q)),b.lineTo(q,H),b.lineTo(q,s),v&&(d.lineTo(q,H),d.lineTo(q,s))):(b.beginPath(),b.moveTo(q,s),v&&(d.beginPath(),d.moveTo(q,s)),t={x:q,y:s}),G=e=!1):(b.lineTo(q,H),v&&d.lineTo(q,H),b.lineTo(q,s),v&&d.lineTo(q,s),0==r%250&&
c()),r<p.length-1&&(A!==(p[r].lineColor||z)||R!==(p[r].lineDashType||m.lineDashType))&&(c(),A=p[r].lineColor||z,b.strokeStyle=A,b.setLineDash&&(p[r].lineDashType?(R=p[r].lineDashType,b.setLineDash(F(R,m.lineThickness))):(R=m.lineDashType,b.setLineDash(I)))),H=m.dataPointIds[r],this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:r,x1:q,y1:s},0!==p[r].markerSize&&(0<p[r].markerSize||0<m.markerSize)&&(u=m.getMarkerProperties(r,q,s,b),h=u.color,k.push(u),H=D(H),
v&&k.push({x:q,y:s,ctx:d,type:u.type,size:u.size,color:H,borderColor:H,borderThickness:u.borderThickness})),(p[r].indexLabel||m.indexLabel||p[r].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:p[r],dataSeries:m,point:{x:q,y:s},direction:0>p[r].y===a.axisY.reversed?1:-1,color:x}))}c();O.drawMarkers(k);m.markerColor=h}}b.restore();v&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,
...
f,g,c);c.globalAlpha=l.fillOpacity;O.drawMarker(e.x,e.y,e.ctx,e.type,e.size,e.color,e.borderColor,e.borderThickness);c.globalAlpha=1;Math.sqrt((m-f)*(m-f)+(p-g)*(p-g))<Math.min(e.size,5)&&n.length>Math.min(this.plotArea.width,this.plotArea.height)||(m=l.dataPointIds[d],this._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:d,x1:f,y1:g},m=D(m),v&&O.drawMarker(e.x,e.y,this._eventManager.ghostCtx,e.type,e.size,m,m,e.borderThickness),(n[d].indexLabel||l.indexLabel||
...
[],l=a.dataSeriesIndexes[k],n=this.data[l],m=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:l};f=D(f);d.fillStyle=f;var f=[],p=!0,e=0,r,q,s,u,w=null;if(0<m.length){var y=n._colorSet[e%n._colorSet.length],t=n.lineColor=n.options.lineColor||y,x=t;b.fillStyle=y;b.strokeStyle=t;b.lineWidth=n.lineThickness;var z="solid";if(b.setLineDash){var A=F(n.nullDataLineDashType,n.lineThickness),z=n.lineDashType,C=F(z,n.lineThickness);b.setLineDash(C)}for(var R=!0;e<
m.length;e++)if(u=m[e].x.getTime?m[e].x.getTime():m[e].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!R)))if(null!==m[e].y&&m[e].y.length&&"number"===typeof m[e].y[0]&&"number"===typeof m[e].y[1]){r=a.axisX.convertValueToPixel(u);q=a.axisY.convertValueToPixel(m[e].y[0]);s=a.axisY.convertValueToPixel(m[e].y[1]);p||R?(n.connectNullData&&!p?(b.setLineDash&&(n.options.nullDataLineDashType||z===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-
1].newLineDashArray=C,z=n.nullDataLineDashType,b.setLineDash(A)),b.lineTo(r,q),v&&d.lineTo(r,q),h.push({x:r,y:s})):(b.beginPath(),b.moveTo(r,q),w={x:r,y:q},h=[],h.push({x:r,y:s}),v&&(d.beginPath(),d.moveTo(r,q))),R=p=!1):(b.lineTo(r,q),h.push({x:r,y:s}),v&&d.lineTo(r,q),0==e%250&&c());u=n.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:l,dataPointIndex:e,x1:r,y1:q,y2:s};e<m.length-1&&(x!==(m[e].lineColor||t)||z!==(m[e].lineDashType||n.lineDashType))&&(c(),
...
l.getMarkerProperties(m,p,e,b),g=C.color;f.push(C);var R=D(A);v&&f.push({x:p,y:e,ctx:d,type:C.type,size:C.size,color:R,borderColor:R,borderThickness:C.borderThickness});C=l.getMarkerProperties(m,p,r,b);f.push(C);R=D(A);v&&f.push({x:p,y:r,ctx:d,type:C.type,size:C.size,color:R,borderColor:R,borderThickness:C.borderThickness})}if(n[m].indexLabel||l.indexLabel||n[m].indexLabelFormatter||l.indexLabelFormatter)this._indexLabels.push({chartType:"splineArea",dataPoint:n[m],dataSeries:l,indexKeyword:0,point:{x:p,
y:e},direction:n[m].y[0]<=n[m].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"splineArea",dataPoint:n[m],dataSeries:l,indexKeyword:1,point:{x:p,y:r},direction:n[m].y[0]<=n[m].y[1]?1:-1,color:u});e=!1}else 0<m&&!e&&(l.connectNullData?b.setLineDash&&(0<q.length&&(l.options.nullDataLineDashType||!n[m-1].lineDashType))&&(q[q.length-1].newLineDashArray=z,t=l.nullDataLineDashType):(c(x,w),q=[],s=[])),e=!0;c(x,w);O.drawMarkers(f);l.markerColor=g}}b.restore();v&&this._eventManager.ghostCtx.restore();
...
this.verticalAlign&&(this.orientation="vertical",b=this.horizontalAlign,g=this.maxWidth=null!==this.maxWidth?this.maxWidth:0.5*c.width,k=this.maxHeight=null!==this.maxHeight?this.maxHeight:c.height);for(var m=0;m<this.dataSeries.length;m++){var p=this.dataSeries[m];if("pie"!==p.type&&"doughnut"!==p.type&&"funnel"!==p.type){var e=p.legendMarkerType=p.legendMarkerType?p.legendMarkerType:"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type&&"scatter"!==p.type&&"bubble"!==p.type||!p.markerType?ba.getDefaultLegendMarker(p.type):
...
Math.max(1,Math.round(0.2*s)):0,r=this.chart.replaceKeywordsWithValue(r,p.dataPoints[0],p,m),e={markerType:e,markerColor:q,text:r,textBlock:null,chartType:p.type,markerSize:s,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:u,markerBorderThickness:w};l.push(e)}else for(var v=0;v<p.dataPoints.length;v++){var t=p.dataPoints[v],e=t.legendMarkerType?t.legendMarkerType:p.legendMarkerType?p.legendMarkerType:ba.getDefaultLegendMarker(p.type),r=t.legendText?t.legendText:
...
2;e.x2=this.chart._eventManager.objectMap[e.id].x2=e.textBlock.x+e.textBlock.width;e.y2=this.chart._eventManager.objectMap[e.id].y2=e.textBlock.y+e.textBlock.height-this.lineHeight/2}c+=v}0<l.length&&a.layoutManager.registerSpace(b,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:f,y1:d,x2:f+this.width,y2:d+this.height}};U(Da,J);Da.prototype.render=function(){var a=this.chart.layoutManager.getFreeSpace();this.ctx.fillStyle="red";this.ctx.fillRect(a.x1,a.y1,a.x2,a.y2)};U(ba,J);ba.prototype.getDefaultAxisPlacement=
...
a||"funnel"===a)return"circle";if("area"===a||"splineArea"===a||"stackedArea"===a||"stackedArea100"===a)return"triangle";window.console.log("Unknown Chart Type: "+a);return null};ba.prototype.getDataPointAtX=function(a,c){if(!this.dataPoints||0===this.dataPoints.length)return null;var b={dataPoint:null,distance:Infinity,index:NaN},d=null,f=0,g=0,k=1,h=Infinity,l=0,n=0,m=0;"none"!==this.chart.plotInfo.axisPlacement&&(this.axisX.logarithmic?(m=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),
...
new W(d[e].ctx,{text:d[e].title,horizontalAlign:"center",fontSize:d[e].titleFontSize,fontFamily:d[e].titleFontFamily,fontWeight:d[e].titleFontWeight,fontColor:d[e].titleFontColor,fontStyle:d[e].titleFontStyle,textBaseline:"top"}));if("normal"===f){var u=[],w=[],v=[],t=[],H=[],J=[],K=[],M=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&a[e].title&&(a[e]._titleTextBlock.maxWidth=a[e].titleMaxWidth||g.width,a[e]._titleTextBlock.maxHeight=a[e].titleWrap?0.8*g.height:1.5*a[e].titleFontSize,a[e]._titleTextBlock.angle=
...
d[e].title&&(d[e]._titleTextBlock.maxWidth=d[e].titleMaxWidth||g.height,d[e]._titleTextBlock.maxHeight=d[e].titleWrap?0.8*g.width:1.5*d[e].titleFontSize,d[e]._titleTextBlock.angle=90);for(;4>r;){var L=0,O=0,P=0,N=0,Z=f=0,B=0,S=0,Y=0,V=0,U=0,T=0;if(b&&0<b.length)for(v=[],e=U=0;e<b.length;e++)v.push(Math.ceil(b[e]?b[e].createLabelsAndCalculateWidth():0)),U+=v[e],B+=b[e]?b[e].margin:0;else v.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));K.push(v);if(d&&0<d.length)for(t=[],e=T=0;e<d.length;e++)t.push(Math.ceil(d[e]?
d[e].createLabelsAndCalculateWidth():0)),T+=t[e],S+=d[e]?d[e].margin:0;else t.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():0));M.push(t);k=Math.round(g.x1+U+B);l=Math.round(g.x2-T-S>m.width-10?m.width-10:g.x2-T-S);if(a&&0<a.length)for(u=[],e=Y=0;e<a.length;e++)a[e]&&(a[e].lineCoordinates={}),a[e].lineCoordinates.width=Math.abs(l-k),a[e].title&&(a[e]._titleTextBlock.maxWidth=0<a[e].titleMaxWidth&&a[e].titleMaxWidth<a[e].lineCoordinates.width?a[e].titleMaxWidth:a[e].lineCoordinates.width),
...
f+L),n=Math.round(g.y2),a[e].lineCoordinates.x2=l,a[e].lineCoordinates.width=l-k,a[e].lineCoordinates.y1=h,a[e].lineCoordinates.y2=h,a[e].bounds={x1:k,y1:h,x2:l,y2:n-(Y+f-u[e]-L),width:l-k,height:n-h}),L+=u[e]+a[e].margin;if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].lineCoordinates.x1=Math.round(g.x1+U+B),c[e].lineCoordinates.x2=Math.round(g.x2-T-S>m.width-10?m.width-10:g.x2-T-S),c[e].lineCoordinates.width=Math.abs(l-k),c[e]._labels&&1<c[e]._labels.length&&(n=c[e]._labels[1],h="dateTime"===c[e].chart.plotInfo.axisXValueType?
...
n=Math.round(g.y2+c[e].margin),c[e].lineCoordinates.y1=h+V+Z-O,c[e].lineCoordinates.y2=h,c[e].bounds={x1:k,y1:h+(V+Z-w[e]-O),x2:l,y2:n,width:l-k,height:n-h},O+=w[e]+c[e].margin;if(b&&0<b.length)for(e=0;e<b.length;e++)B=10,b[e]&&(k=Math.round(a[0]?a[0].lineCoordinates.x1:c[0].lineCoordinates.x1),B=b[e]._labels&&0<b[e]._labels.length?b[e]._labels[b[e]._labels.length-1].textBlock.height/2:10,h=Math.round(g.y1+V+Z<Math.max(B,10)?Math.max(B,10):g.y1+V+Z),l=Math.round(a[0]?a[0].lineCoordinates.x1:c[0].lineCoordinates.x1),
B=0<a.length?0:b[e]._labels[0].textBlock.height/2,n=Math.round(g.y2-Y-f-B),b[e].lineCoordinates={x1:l-P,y1:h,x2:l-P,y2:n,height:Math.abs(n-h)},b[e].bounds={x1:k-(v[e]+P),y1:h,x2:l,y2:n,width:l-k,height:n-h},b[e].title&&(b[e]._titleTextBlock.maxWidth=0<b[e].titleMaxWidth&&b[e].titleMaxWidth<b[e].lineCoordinates.height?b[e].titleMaxWidth:b[e].lineCoordinates.height),P+=v[e]+b[e].margin);if(d&&0<d.length)for(e=0;e<d.length;e++)d[e]&&(k=Math.round(a[0]?a[0].lineCoordinates.x2:c[0].lineCoordinates.x2),
l=Math.round(k),B=d[e]._labels&&0<d[e]._labels.length?d[e]._labels[d[e]._labels.length-1].textBlock.height/2:0,h=Math.round(g.y1+V+Z<Math.max(B,10)?Math.max(B,10):g.y1+V+Z),B=0<a.length?0:d[e]._labels[0].textBlock.height/2,n=Math.round(g.y2-(Y+f+B)),d[e].lineCoordinates={x1:k+N,y1:h,x2:k+N,y2:n,height:Math.abs(n-h)},d[e].bounds={x1:k,y1:h,x2:l+(t[e]+N),y2:n,width:l-k,height:n-h},d[e].title&&(d[e]._titleTextBlock.maxWidth=0<d[e].titleMaxWidth&&d[e].titleMaxWidth<d[e].lineCoordinates.height?d[e].titleMaxWidth:
d[e].lineCoordinates.height),N+=t[e]+d[e].margin);if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&(a[e].calculateValueToPixelConversionParameters(),a[e]._labels&&1<a[e]._labels.length&&(z=(a[e].logarithmic?Math.log(a[e]._labels[1].position/a[e].viewportMinimum)/a[e].conversionParameters.lnLogarithmBase:a[e]._labels[1].position-a[e].viewportMinimum)*Math.abs(a[e].conversionParameters.pixelPerUnit)+a[e].lineCoordinates.x1,A="dateTime"===a[e].chart.plotInfo.axisXValueType?(a[e].logarithmic?Math.log(a[e]._labels[a[e]._labels.length-
...
if(d&&0<d.length)for(e=0;e<d.length;e++)d[e].calculateValueToPixelConversionParameters();if(0<r){if(a&&0<a.length)for(e=0;e<a.length;e++)D=H[r-1][e]===H[r][e]?!0:!1;else D=!0;if(c&&0<c.length)for(e=0;e<c.length;e++)E=J[r-1][e]===J[r][e]?!0:!1;else E=!0;if(b&&0<b.length)for(e=0;e<b.length;e++)F=K[r-1][e]===K[r][e]?!0:!1;else F=!0;if(d&&0<d.length)for(e=0;e<d.length;e++)I=M[r-1][e]===M[r][e]?!0:!1;else I=!0}if(D&&E&&F&&I)break;r++}p.save();p.beginPath();a[0]&&p.rect(5,a[0].bounds.y1,a[0].chart.width-
10,a[0].bounds.height);c[0]&&p.rect(5,c[c.length-1].bounds.y1,c[0].chart.width-10,c[0].bounds.height);p.clip();if(a&&0<a.length)for(e=0;e<a.length;e++)a[e].renderLabelsTicksAndTitle();if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].renderLabelsTicksAndTitle();p.restore();if(b&&0<b.length)for(e=0;e<b.length;e++)b[e].renderLabelsTicksAndTitle();if(d&&0<d.length)for(e=0;e<d.length;e++)d[e].renderLabelsTicksAndTitle()}else{z=[];A=[];C=[];q=[];s=[];H=[];J=[];K=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&
...
b[e].titleMaxWidth||g.width,b[e]._titleTextBlock.maxHeight=b[e].titleWrap?0.8*g.height:1.5*b[e].titleFontSize,b[e]._titleTextBlock.angle=0);if(d&&0<d.length)for(e=0;e<d.length;e++)d[e]&&d[e].title&&(d[e]._titleTextBlock.maxWidth=d[e].titleMaxWidth||g.width,d[e]._titleTextBlock.maxHeight=d[e].titleWrap?0.8*g.height:1.5*d[e].titleFontSize,d[e]._titleTextBlock.angle=0);for(;4>r;){V=Y=U=N=S=B=Z=f=P=M=O=L=0;if(a&&0<a.length)for(C=[],e=Y=0;e<a.length;e++)C.push(Math.ceil(a[e]?a[e].createLabelsAndCalculateWidth():
0)),Y+=C[e],f+=a[e]?a[e].margin:0;else C.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));J.push(C);if(c&&0<c.length)for(q=[],e=V=0;e<c.length;e++)q.push(Math.ceil(c[e]?c[e].createLabelsAndCalculateWidth():0)),V+=q[e],Z+=c[e]?c[e].margin:0;else q.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));K.push(q);if(b&&0<b.length)for(e=0;e<b.length;e++)b[e].lineCoordinates={},k=Math.round(g.x1+Y+f),l=Math.round(g.x2-V-Z>m.width-10?m.width-10:g.x2-V-Z),b[e].labelAutoFit&&!x(u)&&(0<!a.length&&
...
b[e].chart.height-10:g.y2),b[e].lineCoordinates.y1=h-(z[e]+b[e].margin+L),b[e].lineCoordinates.y2=h-(z[e]+b[e].margin+L),b[e].bounds={x1:k,y1:h-(z[e]+L+b[e].margin),x2:l,y2:n-(L+b[e].margin),width:l-k,height:z[e]},b[e].title&&(b[e]._titleTextBlock.maxWidth=0<b[e].titleMaxWidth&&b[e].titleMaxWidth<b[e].lineCoordinates.width?b[e].titleMaxWidth:b[e].lineCoordinates.width),L+=z[e]+b[e].margin;if(d&&0<d.length)for(e=d.length-1;0<=e;e--)d[e]&&(h=Math.round(g.y1),n=Math.round(g.y1+(A[e]+d[e].margin+O)),
d[e].lineCoordinates.y1=n,d[e].lineCoordinates.y2=n,d[e].bounds={x1:k,y1:h+(d[e].margin+O),x2:l,y2:n,width:l-k,height:U},d[e].title&&(d[e]._titleTextBlock.maxWidth=0<d[e].titleMaxWidth&&d[e].titleMaxWidth<d[e].lineCoordinates.width?d[e].titleMaxWidth:d[e].lineCoordinates.width),O+=A[e]+d[e].margin);if(a&&0<a.length)for(e=0;e<a.length;e++){B=a[e]._labels&&0<a[e]._labels.length?a[e]._labels[0].textBlock.fontSize/2:0;k=Math.round(g.x1+f);h=d&&0<d.length?Math.round(d[0]?d[0].lineCoordinates.y2:g.y1<Math.max(B,
10)?Math.max(B,10):g.y1):g.y1<Math.max(B,10)?Math.max(B,10):g.y1;l=Math.round(g.x1+Y+f);n=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y1:g.y2-N>m.height-Math.max(B,10)?m.height-Math.max(B,10):g.y2-N):g.y2>m.height-Math.max(B,10)?m.height-Math.max(B,10):g.y2;if(b&&0<b.length)for(B=0;B<b.length;B++)b[B]&&b[B].labelAutoFit&&(l=0>b[B].labelAngle?Math.max(l,u):0===b[B].labelAngle?Math.max(l,u/2):l,k=0>b[B].labelAngle||0===b[B].labelAngle?l-Y:k);if(d&&0<d.length)for(B=0;B<d.length;B++)d[B]&&d[B].labelAutoFit&&
(l=d[B].lineCoordinates.x1,k=l-Y);a[e].lineCoordinates={x1:l-M,y1:h,x2:l-M,y2:n,height:Math.abs(n-h)};a[e].bounds={x1:l-(C[e]+M),y1:h,x2:l,y2:n,width:l-k,height:n-h};a[e].title&&(a[e]._titleTextBlock.maxWidth=0<a[e].titleMaxWidth&&a[e].titleMaxWidth<a[e].lineCoordinates.height?a[e].titleMaxWidth:a[e].lineCoordinates.height);a[e].calculateValueToPixelConversionParameters();M+=C[e]+a[e].margin}if(c&&0<c.length)for(e=0;e<c.length;e++){B=c[e]._labels&&0<c[e]._labels.length?c[e]._labels[0].textBlock.fontSize/
2:0;k=Math.round(g.x1-f);h=d&&0<d.length?Math.round(d[0]?d[0].lineCoordinates.y2:g.y1<Math.max(B,10)?Math.max(B,10):g.y1):g.y1<Math.max(B,10)?Math.max(B,10):g.y1;l=Math.round(g.x2-V-Z);n=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y1:g.y2-N>m.height-Math.max(B,10)?m.height-Math.max(B,10):g.y2-N):g.y2>m.height-Math.max(B,10)?m.height-Math.max(B,10):g.y2;if(b&&0<b.length)for(B=0;B<b.length;B++)b[B]&&b[B].labelAutoFit&&(l=0>b[e].labelAngle?Math.max(l,u):0===b[e].labelAngle?Math.max(l,u/2):l,k=
0>b[B].labelAngle||0===b[B].labelAngle?l-V:k);if(d&&0<d.length)for(B=0;B<d.length;B++)d[B]&&d[B].labelAutoFit&&(l=d[B].lineCoordinates.x2,k=l-V);c[e].lineCoordinates={x1:l+P,y1:h,x2:l+P,y2:n,height:Math.abs(n-h)};c[e].bounds={x1:k,y1:h,x2:l+q[e]+P,y2:n,width:l-k,height:n-h};c[e].title&&(c[e]._titleTextBlock.maxWidth=0<c[e].titleMaxWidth&&c[e].titleMaxWidth<c[e].lineCoordinates.height?c[e].titleMaxWidth:c[e].lineCoordinates.height);c[e].calculateValueToPixelConversionParameters();P+=q[e]+c[e].margin}if(b&&
0<b.length)for(e=0;e<b.length;e++)b[e].calculateValueToPixelConversionParameters();if(d&&0<d.length)for(e=0;e<d.length;e++)d[e].calculateValueToPixelConversionParameters();if(0<r){if(a&&0<a.length)for(e=0;e<a.length;e++)D=J[r-1][e]===J[r][e]?!0:!1;else D=!0;if(c&&0<c.length)for(e=0;e<c.length;e++)E=K[r-1][e]===K[r][e]?!0:!1;else E=!0;if(b&&0<b.length)for(e=0;e<b.length;e++)F=s[r-1][e]===s[r][e]?!0:!1;else F=!0;if(d&&0<d.length)for(e=0;e<d.length;e++)I=H[r-1][e]===H[r][e]?!0:!1;else I=!0}if(D&&E&&
...
g=this.chart.plotArea.x2,this.bounds={x1:f,y1:k-c/2,x2:g,y2:h+c/2};this.ctx.moveTo(f,k);this.ctx.lineTo(g,h);this.ctx.stroke();this.ctx.globalAlpha=d}this.ctx.restore()};U(S,J);S.prototype._initialize=function(){if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height="auto";this.container.style.boxShadow="1px 1px 2px 2px rgba(0,0,0,0.1)";this.container.style.zIndex=
...
this.chart._canvasJSContainer.appendChild(this.container)}};S.prototype.mouseMoveHandler=function(a,c){this._lastUpdated&&40>(new Date).getTime()-this._lastUpdated||(this._lastUpdated=(new Date).getTime(),this._updateToolTip(a,c))};S.prototype._updateToolTip=function(a,c,b){b="undefined"===typeof b?!0:b;this.container||this._initialize();this.enabled||this.hide();if(!this.chart.disableToolTip){if("undefined"===typeof a||"undefined"===typeof c){if(isNaN(this._prevX)||isNaN(this._prevY))return;a=this._prevX;
...
!0!==d.highlightEnabled&&!0!==g.highlightEnabled||("line"===d.type||"stepLine"===d.type||"spline"===d.type||"scatter"===d.type||"area"===d.type||"stepArea"===d.type||"splineArea"===d.type||"stackedArea"===d.type||"stackedArea100"===d.type||"rangeArea"===d.type||"rangeSplineArea"===d.type?(g=d.getMarkerProperties(k,f.x1,f.y1,this.chart.overlaidCanvasCtx),g.size=Math.max(1.5*g.size<<0,10),g.borderColor=g.borderColor||"#FFFFFF",g.borderThickness=g.borderThickness||Math.ceil(0.1*g.size),O.drawMarkers([g]),
"undefined"!==typeof f.y2&&(g=d.getMarkerProperties(k,f.x1,f.y2,this.chart.overlaidCanvasCtx),g.size=Math.max(1.5*g.size<<0,10),g.borderColor=g.borderColor||"#FFFFFF",g.borderThickness=g.borderThickness||Math.ceil(0.1*g.size),O.drawMarkers([g]))):"bubble"===d.type?(g=d.getMarkerProperties(k,f.x1,f.y1,this.chart.overlaidCanvasCtx),g.size=f.size,g.color="white",g.borderColor="white",c.globalAlpha=0.3,O.drawMarkers([g]),c.globalAlpha=1):"column"===d.type||"stackedColumn"===d.type||"stackedColumn100"===
...
f.y4),c.lineTo(f.x2,f.y4),c.stroke(),c.globalAlpha=1))}}c.restore();c.globalAlpha=1;c.beginPath()};S.prototype.getToolTipInnerHTML=function(a){a=a.entries;for(var c=null,b=null,d=null,f=0,g="",k=!0,h=0;h<a.length;h++)if(a[h].dataSeries.toolTipContent||a[h].dataPoint.toolTipContent){k=!1;break}if(k&&(this.content&&"function"===typeof this.content||this.contentFormatter))a={chart:this.chart,toolTip:this.options,entries:a},c=this.contentFormatter?this.contentFormatter(a):this.content(a);else if(this.shared&&
...
b.xValueFormatString?b.xValueFormatString:b.xValueFormatString="#,##0.########",g._cultureInfo);else return"y"===a?da(h,c.yValueFormatString?c.yValueFormatString:b.yValueFormatString?b.yValueFormatString:b.yValueFormatString="#,##0.########",g._cultureInfo):"z"===a?da(h,c.zValueFormatString?c.zValueFormatString:b.zValueFormatString?b.zValueFormatString:b.zValueFormatString="#,##0.########",g._cultureInfo):h})};ma.prototype.reset=function(){this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=
[];this.previousDataPointEventObject=null;this.eventObjects=[];v&&(this.ghostCtx.clearRect(0,0,this.chart.width,this.chart.height),this.ghostCtx.beginPath())};ma.prototype.getNewObjectTrackingId=function(){return++this.lastObjectId};ma.prototype.mouseEventHandler=function(a){if("mousemove"===a.type||"click"===a.type){var c=[],b=za(a),d=null;if((d=this.chart.getObjectAtXY(b.x,b.y,!1))&&"undefined"!==typeof this.objectMap[d])if(d=this.objectMap[d],"dataPoint"===d.objectType){var f=this.chart.data[d.dataSeriesIndex],
...
a){var b=c.dest,d=c.source.canvas,f=c.animationBase;b.drawImage(d,0,0,d.width,d.height,0,f-f*a,b.canvas.width/L,a*b.canvas.height/L)}},xScaleAnimation:function(a,c){if(0!==a){var b=c.dest,d=c.source.canvas,f=c.animationBase;b.drawImage(d,0,0,d.width,d.height,f-f*a,0,a*b.canvas.width/L,b.canvas.height/L)}},xClipAnimation:function(a,c){if(0!==a){var b=c.dest,d=c.source.canvas;b.save();0<a&&b.drawImage(d,0,0,d.width*a,d.height,0,0,d.width*a/L,d.height/L);b.restore()}},fadeInAnimation:function(a,c){if(0!==
a){var b=c.dest,d=c.source.canvas;b.save();b.globalAlpha=a;b.drawImage(d,0,0,d.width,d.height,0,0,b.canvas.width/L,b.canvas.height/L);b.restore()}},easing:{linear:function(a,c,b,d){return b*a/d+c},easeOutQuad:function(a,c,b,d){return-b*(a/=d)*(a-2)+c},easeOutQuart:function(a,c,b,d){return-b*((a=a/d-1)*a*a*a-1)+c},easeInQuad:function(a,c,b,d){return b*(a/=d)*a+c},easeInQuart:function(a,c,b,d){return b*(a/=d)*a*a*a+c}}},O={drawMarker:function(a,c,b,d,f,g,k,h){if(b){var l=1;b.fillStyle=g?g:"#000000";
